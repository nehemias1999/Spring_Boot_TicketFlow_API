...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleEventNotFoundException(
    ...
    public ResponseEntity<ApiErrorResponse> handleTicketNotFoundException(
        ...
        log.warn("Ticket not found on request to '{}': {}", request.getRequestURI(), ex.getMessage());
    ...
    /**
     * Handles {@link TicketAlreadyCancelledException} when attempting to cancel
     * a ticket that is already cancelled.
     *
     * @param ex      the exception thrown
     * @param request the HTTP request that triggered the error
    ...
    public ResponseEntity<ApiErrorResponse> handleTicketAlreadyCancelledException(
            TicketAlreadyCancelledException ex, HttpServletRequest request) {
        log.warn("Ticket cancellation conflict on request to '{}': {}", request.getRequestURI(), ex.getMessage());
